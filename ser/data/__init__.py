...
Bu __init__, alt modüllerdeki en çok kullanılan isimleri paket seviyesine
taşır; böylece diğer modüller ``from ser.data import prepare_splits`` gibi
kısa importlar yazabilir ve iç dosya düzeni değişse bile dış arayüz sabit kalır.
"""
